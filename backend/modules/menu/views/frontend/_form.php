...
<div class="row">
    ...
    <?= $form->field($model, 'parent_id',['options'=>['class'=>'control-group span8']])->dropdownList(MenuService::getParentList(MenuEnum::TYPE_FRONTEND, $model->isNewRecord ? null : $model->id)
...
<div class="row">
    <?= $form->field($model, 'status',['options'=>['class'=>'control-group span8']])->dropdownList(MenuEnum::getStatus()
            , ['class' => 'form-control', 'prompt' => '请选择'])?>
    <?= $form->field($model, 'type',['options'=>['class'=>'control-group span8']])->hiddenInput(['value' => MenuEnum::TYPE_FRONTEND])->label(false) ?>
</div>
